...
public class MainCelulares {
    public static void main(String[] args) {
        ...
        // Relacionamos a las personas con sus respectivos main.ejercicioCelulares
        juliana.setCelular(celSamsung);
        catalina.setCelular(celIphone);

        // Recargamos los main.ejercicioCelulares para asegurarnos de que puedan usarlos
        ...
        // Seguimos probando, checkeando que ambos main.ejercicioCelulares
